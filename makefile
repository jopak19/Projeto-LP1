...
petshop.so: $(SRC)/anfibio.cpp $(SRC)/anfibioexotico.cpp $(SRC)/anfibionativo.cpp $(SRC)/animal.cpp $(SRC)/ave.cpp $(SRC)/aveexotico.cpp $(SRC)/avenativo.cpp $(SRC)/exotico.cpp $(SRC)/funcionario.cpp $(SRC)/mamifero.cpp $(SRC)/mamiferoexotico.cpp $(SRC)/mamiferonativo.cpp $(SRC)/nativo.cpp $(SRC)/reptil.cpp $(SRC)/reptilexotico.cpp $(SRC)/reptilnativo.cpp $(SRC)/silvestre.cpp $(SRC)/tratador.cpp $(SRC)/veterinario.cpp $(INC)/anfibio.hpp $(INC)/anfibioexotico.hpp $(INC)/anfibionativo.hpp $(INC)/animal.hpp $(INC)/ave.hpp $(INC)/aveexotico.hpp $(INC)/avenativo.hpp $(INC)/exotico.hpp $(INC)/funcionario.hpp $(INC)/mamifero.hpp $(INC)/mamiferoexotico.hpp $(INC)/mamiferonativo.hpp $(INC)/nativo.hpp $(INC)/reptil.hpp $(INC)/reptilexotico.hpp $(INC)/reptilnativo.hpp $(INC)/silvestre.hpp $(INC)/tratador.hpp $(INC)/veterinario.hpp
